...
We ran the simulation for a maximum of $T_{max}=20000$ time steps. If after a
generation all agents are either social or individual learners then the
simulation is stopped since there is no mutation. At
