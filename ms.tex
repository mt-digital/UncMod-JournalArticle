...
\begin{figure}
  ...
  \begin{subfigure}{\textwidth}
	\caption{$N=50$}
	% \includegraphics[width=\textwidth]{Figures/supplement/sensitivity_N=50/mainResultsPlots.pdf}
  \end{subfigure}
\end{figure}
...
\begin{figure}
  \ContinuedFloat
	\begin{subfigure}{\textwidth}
	  \caption{$N=200$}
	  % \includegraphics[width=\textwidth]{Figures/supplement/sensitivity_N=200/mainResultsPlots.pdf}
	\end{subfigure}
\end{figure}
...
\begin{figure}
  \ContinuedFloat
	\begin{subfigure}{\textwidth}
	  \caption{$N=1000$}
	  % \includegraphics[width=\textwidth]{Figures/supplement/sensitivity_N=1000/mainResultsPlots.pdf}
	\end{subfigure}
\end{figure}
