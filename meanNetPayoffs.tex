...
\begin{tikzpicture}
    ...
    \begin{center}
      \includegraphics[width=1.25in]{Figures/legendElements/solid.pdf}
      {\Huge Simulations} \quad \quad 
      \includegraphics[width=1.25in]{Figures/legendElements/ldash.pdf}
      {\Huge$\meanasoc$} \quad \quad 
      \includegraphics[width=1.25in]{Figures/legendElements/dot.pdf}
      {\Huge$\meansoc$} \quad \quad
      \includegraphics[width=1.25in]{Figures/legendElements/ldashdot.pdf}
      {\Huge$\meanasoc = \meansoc$}
    \end{center}
\end{document}
