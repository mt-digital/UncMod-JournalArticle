...
nagents_supplement_figures:
	pdflatex -output-directory=Figures/supplement/numagents=50 Figures/supplement/numagents=50/mainResultsPlots.tex && \
	pdflatex -output-directory=Figures/supplement/numagents=200 Figures/supplement/numagents=200/mainResultsPlots.tex  
