...
\begin{tikzpicture}
    ...
    \begin{center}
       \includegraphics[width=1.15in]{Figures/legendElements/dot.pdf}
       {\huge Average all-social population payoffs}  \\[1.125em]
       \includegraphics[width=1.15in]{Figures/legendElements/ldash.pdf} 
       {\huge Average all-asocial population payoffs} \\[1.125em]
       \includegraphics[width=1.15in]{Figures/legendElements/solid.pdf} 
       {\huge Simulated average population payoffs} \\[1.125em]
       {\Large $\pmb{|}$ \huge \quad $u$ value where homogenous social and asocial payoffs
      are equal} 
    \end{center}
