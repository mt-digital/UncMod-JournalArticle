...
%Each behavior yields a payoff of either 1 or 0 with some probability that is held fixed within a generation but can change between generations. This probability is therefore equal to the behavior's expected payoff within a generation. 
