...
expected payoffs in populations performing the optimal strategy, in several specific
...
behaviors when the agent is more certain which are most beneficial. Selection
for or against social learners occurs when agents are chosen to reproduce 
with replacement, with probability
of reproduction biased by net payoffs in each generation. 

Several agent-level variables are required to operationalize individual and social
learning
