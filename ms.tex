...
or asocial. We observed two distinct trends in the evolution of social learning as
$L$ was varied.  First, when $\pilow$ was sufficiently small ($\pilow=0.1, 0.45$),
we observed that shorter lifespan selected for social learning for some values of
$u$.  When $\pilow=0.8$, shorter lifespans decreased $\meansl$ in some cases and
increased $\meansl$ in other cases due to greater evolutionary drift.  In the first
...
% By disambiguating and organizing various
% operationalizations of uncertainty, we developed a more nuanced theoretical
% understanding of which forms of uncertainty interact in which ways to make social
% learning more or less beneficial compared to asocial learning. 
